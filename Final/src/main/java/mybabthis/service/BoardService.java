...
public interface BoardService {
	...
	int getAllPageNumInMeeting(); //페이지넘버
	
	List<Board> getAllCommentInMeeting(int page); // 페이지별 리스트
	
	int getAllPageNumInBoard(); //페이지넘버
	
	List<Board> getAllCommentInBoard(int page); // 페이지별 리스트
}
