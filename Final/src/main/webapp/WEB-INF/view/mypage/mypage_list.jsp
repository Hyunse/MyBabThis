		...
		<c:url value="/msg/main" var="message" />
			<section class="color-5">
				<nav class="cl-effect-5">
					<a href="${myinfo}"><span class="linkspan" data-hover="개인정보">개인정보</span></a> 
					<a href="${list}"><span class="linkspan" data-hover="즐겨찾기">즐겨찾기</span></a> 
					<a href="${myfriends}"><span class="linkspan" data-hover="친구">친구</span></a> 
